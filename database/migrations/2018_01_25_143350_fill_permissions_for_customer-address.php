...
class FillPermissionsForCustomerAddress extends Migration
{
    protected $roles;
    ...
    public function __construct()
    {
        //New permissions
        $this->permissions = [
            ['name' => 'admin.customer-address',],
            ['name' => 'admin.customer-address.index',],
            ['name' => 'admin.customer-address.create',],
            ['name' => 'admin.customer-address.show',],
            ['name' => 'admin.customer-address.edit',],
            ['name' => 'admin.customer-address.delete',],
        ];
        ...
        $this->roles = [
            [
                ...
                'permissions' => [
                    ...
                    'admin.customer-address.index',
                    'admin.customer-address.create',
                    'admin.customer-address.show',
