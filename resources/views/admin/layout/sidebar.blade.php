<div class="sidebar">
    <nav class="sidebar-nav">
        <ul class="nav">
            ...
            <li class="nav-item"><a class="nav-link" href="{{ url('admin/export') }}"><i class="icon-plane"></i> <span class="nav-link-text">{{ trans('Export') }}</span></a></li>
            <li class="nav-item"><a class="nav-link" href="{{ url('admin/miscs') }}"><i class="icon-energy"></i> <span class="nav-link-text">{{ trans('admin.misc.title') }}</span></a></li>
